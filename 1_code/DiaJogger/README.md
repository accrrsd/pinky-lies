...
1. [**`diajogger_event.gd`**](file:///workspace/1_code/DiaJogger/diajogger_event.gd) (`DiaJoggerEvent`):
...
2. [**`diajogger_state.gd`**](file:///workspace/1_code/DiaJogger/diajogger_state.gd) (`DiaJoggerState`):
...
3. [**`diajogger_document.gd`**](file:///workspace/1_code/DiaJogger/diajogger_document.gd) (`DiaJoggerDocument`):
...
4. [**`diajogger_caret.gd`**](file:///workspace/1_code/DiaJogger/diajogger_caret.gd) (`DiaJoggerCaret`):
...
5. [**`diajogger_parser.gd`**](file:///workspace/1_code/DiaJogger/diajogger_parser.gd) (`DiaJoggerParser`):
...
6. [**`diajogger_view.gd`**](file:///workspace/1_code/DiaJogger/diajogger_view.gd) (`DiaJoggerView`):
...
7. [**`diajogger_runtime.gd`**](file:///workspace/1_code/DiaJogger/diajogger_runtime.gd) (`DiaJoggerRuntime`):
...
8. [**`diajogger.gd`**](file:///workspace/1_code/DiaJogger/diajogger.gd) (`DiaJoggerFacade` / Autoload `DiaJogger`):
...
9. [**`examples/`**](file:///workspace/1_code/DiaJogger/examples):
   - [`DemoDialogueScene.tscn`](file:///workspace/1_code/DiaJogger/examples/DemoDialogueScene.tscn): Complete playable test scene with background, character sprites, and click-anywhere advance.
   - [`demo_dialogue_scene.gd`](file:///workspace/1_code/DiaJogger/examples/demo_dialogue_scene.gd): Controller script handling dialogue start, choices, and scene mood changes.
   - [`vn_dialogue_view.gd`](file:///workspace/1_code/DiaJogger/examples/vn_dialogue_view.gd): Custom visual novel view with speaker tag, typewriter effect, and emotion animations.
   - [`station.md`](file:///workspace/1_code/DiaJogger/examples/station.md): Example dialogue script in Markdown with branching.
   - [`dialogue_demo.gd`](file:///workspace/1_code/DiaJogger/examples/dialogue_demo.gd): Minimal headless GDScript example demonstrating game-side flow.
   - [**`notebook/`**](file:///workspace/1_code/DiaJogger/examples/notebook):
     - [`NotebookDialogueView.tscn`](file:///workspace/1_code/DiaJogger/examples/notebook/NotebookDialogueView.tscn): Specialized dialogue view styled as a spiral notebook with metallic rings and ruled lines.
     - [`notebook_dialogue_view.gd`](file:///workspace/1_code/DiaJogger/examples/notebook/notebook_dialogue_view.gd): View logic supporting notebook checklist choices and fountain pen typography.
     - [`notebook_paper.gd`](file:///workspace/1_code/DiaJogger/examples/notebook/notebook_paper.gd): Custom control drawing ruled paper lines and metallic spiral binding rings.
     - [`NotebookDemoScene.tscn`](file:///workspace/1_code/DiaJogger/examples/notebook/NotebookDemoScene.tscn): Playable investigation journal demo.
